...
public class EconomyControlOfficeMenu extends AbstractContainerMenu {
    private final EconomyControlOfficeBlockEntity blockEntity;
    ...
    public EconomyControlOfficeMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 80, 37));
        });
    }
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ECONOMY_CONTROL_OFFICE.get());
    }
