...
import fr.takkers.crst.screen.slot.ModResultSlot;
...
public class ArtefactExtractorMenu extends AbstractContainerMenu {
    private final ArtefactExtractorBlockEntity blockEntity;
    ...
    // CREDIT GOES TO: diesieben07 and Kaupenjoe ! | https://github.com/diesieben07/SevenCommons
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ARTEFACT_EXTRACTOR.get());
    }
